...
//
//    static final String T_REAL_START_DATE = "real_start_date";
//
//    static final String T_EXPECTED_START_DATE ="expected_start_date";
//
...
//                + T_NAME + " TEXT,"
//                + T_STATUS + " TEXT,"
//                + T_EXPECTED_START_DATE + " TEXT,"
//                + T_REAL_START_DATE + " TEXT,"
...
//        values.put(T_EXPECTED_START_DATE, dateFormat.format(task.getExpected_start_date()));
//        values.put(T_EXPECTED_DURATION, task.getExpected_duration().toString());
//
//
//        // Convert Date to String for storage
//        Date realStartDate = task.getReal_start_date();
//        if (realStartDate != null) {
//            values.put(T_REAL_START_DATE, dateFormat.format(realStartDate));
//        } else {
//            values.putNull(T_REAL_START_DATE);
//        }
//
//
//        Task.Duration realDuration = task.getReal_duration();
...
//                new String[]{T_ID, T_NAME, T_STATUS, T_EXPECTED_START_DATE,
//                        T_REAL_START_DATE, T_EXPECTED_DURATION, T_REAL_DURATION,
...
//
//        // Expected start date
//        if (!cursor.isNull(cursor.getColumnIndexOrThrow(T_EXPECTED_START_DATE))) {
//            String dateStr = cursor.getString(cursor.getColumnIndexOrThrow(T_EXPECTED_START_DATE));
//            try {
//                Date date = dateFormat.parse(dateStr);
//                task.setExpected_start_date(date);
//            } catch (Exception e) {
//                e.printStackTrace();
//                task.setExpected_start_date(null);
//            }
//        }
//
//        // Real start date
//        if (!cursor.isNull(cursor.getColumnIndexOrThrow(T_REAL_START_DATE))) {
//            String dateStr = cursor.getString(cursor.getColumnIndexOrThrow(T_REAL_START_DATE));
//            try {
//                Date date = dateFormat.parse(dateStr);
//                task.setReal_start_date(date);
//            } catch (Exception e) {
//                e.printStackTrace();
//                task.setReal_start_date(null);
//            }
//        }
//
//        // Expected duration
...
//            Task.Duration duration = stringToDuration(durationStr);
...
//        return task;
//    }
//    private String durationToString(Task.Duration duration) {
...
//    }
//
//    private Task.Duration stringToDuration(String durationStr) {
...
//            if (parts.length == 4) {
//                Task.Duration duration = new Task.Duration();
